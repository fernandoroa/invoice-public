...
# main
json_fields_list <- rjson::fromJSON(file = file.path(params$app_path, "json/field_names.json"))
...
emna <- month(json_salary_list$dates$end, label = TRUE, abbr = FALSE)
...
cat( # nolint
  ...
  if (use_dates) {
    paste0("|\\hspace{2mm}", json_salary_list$dates$delivery_month_text, " ", emna, " ", sy, "| | |  |   |   |\n")
  },
