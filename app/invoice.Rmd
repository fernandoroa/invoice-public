...
cat(
  if (use_dates) {
    paste0("|\\hspace{2mm}", "", sdt, " ", sm, " ", sy, " ", json_salary_list$date_connector , " ",edt, " ", em, " ", ey, " | |  |   |   |\n")
  },
  if (use_dates) {
  ...
  if (use_sick && use_salary) {
    paste0(
      "|\\hspace{2mm}", json_sick_list$text, ": ", sick_days, "/", total_days, "|",
      "|", sick_pay, "|", salary_currency_text, "|  |", "\n"
    )
  },
  if ((use_sick | use_nwd) && use_salary) {
    paste0(
      "|\\hspace{2mm}", json_salary_list$otherdays, "\\hspace{4mm}", common_payable_days, "/", total_days, "|",
  ...
  if (use_grouped) {
    ...
    grouped_strings <- c(
      ...
      grouped_strings,
      paste0(
        "|", json_grouped_list$groupedCostsGeneralName, "|", grouped_currency, "|", exchange_grouped_text, "|", total_grouped_finals_exchanged, " ",
        final_currency, "|", "\n"
      )
    )
    grouped_strings
