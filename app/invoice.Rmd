...
total_sum <- salary_days_pay_final + benefits_final + CCE_final + total_grouped_finals_exchanged
...
cat(
  ...
  if (use_grouped) {
    ...
    grouped_strings <- c(
      ...
      grouped_strings,
      paste0(
        "|", json_fields_list$groupedCosts[lan_idx], "|", grouped_currency, "|", exchange_grouped_text, "|", total_grouped_finals_exchanged, " ",
        final_currency, "|", "\n"
      )
    )
    grouped_strings
