...
json_main_list <- rjson::fromJSON(file = "json/final_currency_inv_date.json")
...
json_sick_list <- rjson::fromJSON(file = "json/salary_sick_days.json")
...
salary_days_pay_final <- ifelse(final_to_salary_exchange_condition,
  ...
  round(common_plus_sick_pay / json_salary_list$currency_exchange_to_Final_Currency)
)
